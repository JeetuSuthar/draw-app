    ...
    <div className="py-16 bg-gray-50 dark:bg-gray-900 overflow-hidden lg:py-24" id="how-it-works">
      <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        <div className="relative">
          <h2 className="text-center text-xl sm:text-3xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-gray-100">
            How CollabDraw Works
          </h2>
          <p className="mt-4 max-w-3xl mx-auto text-center text-base sm:text-lg text-gray-500 dark:text-gray-400">
                ...
                return (
                  <div key={step.name} className="relative">
                    <dt>
                      ...
                      <p className="ml-16 text-base sm:text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">
                        {step.name}
                      </p>
                    </dt>
                    <dd className="mt-2 ml-16 text-sm sm:text-base text-gray-500 dark:text-gray-400">
                      {step.description}
                    </dd>
                  </div>
                );
